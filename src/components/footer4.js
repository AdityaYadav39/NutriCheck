        ...
        <div className="footer4-content">
          ...
          <div className="footer4-links">
            ...
            >
              {props.link4 ?? (
                <Fragment>
                  <span className="footer4-text19 thq-body-small">FAQs</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link5 ?? (
                <Fragment>
                  <span className="footer4-text14 thq-body-small">Blog</span>
                </Fragment>
              )}
            </a>
          </div>
        ...
        <div className="footer4-credits">
          ...
          <div className="footer4-row">
            <div className="footer4-container">
              <span className="thq-body-small">© 2024 NutriCheck</span>
            </div>
