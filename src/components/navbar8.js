          ...
          <div className="navbar8-buttons1">
            ...
            <button className="navbar8-action21 thq-button-outline thq-button-animated">
              <span className="thq-body-small">
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text27">Submit</span>
                  </Fragment>
                )}
              </span>
            </button>
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text26 thq-body-small">
                                  View ingredient analysis results and health
                                  ratings
                                </span>
                              </Fragment>
                            )}
...
Navbar8.defaultProps = {
  ...
  action1: undefined,
  page2ImageAlt: 'Upload Image',
  link2: undefined,
  linkUrlPage2: 'https://www.teleporthq.io',
  logoAlt: 'NutriCheck Logo',
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page3ImageAlt: 'Analysis Image',
  linkUrlPage1: 'https://www.teleporthq.io',
  page1: undefined,
  link1: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1654723011680-0e037c2a4f18?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyOTIzNTAwMHw&ixlib=rb-4.0.3&q=80&w=1080',
  linkUrlPage3: 'https://www.teleporthq.io',
  page4: undefined,
  page2: undefined,
  link4: undefined,
  page4ImageAlt: 'Allergies Image',
  page1Description: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1504382103100-db7e92322d39?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyOTIzNTAwMHw&ixlib=rb-4.0.3&q=80&w=1080',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1498612753354-772a30629934?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyOTIzNTAwMnw&ixlib=rb-4.0.3&q=80&w=1080',
