        ...
        <div className="steps2-container2 thq-grid-2">
          <div className="steps2-section-header">
            ...
            <p className="thq-body-large">
              NutriCheck empowers you to make informed choices about the food you consume.
              Analyze ingredients, check health impacts, and get personalized recommendations
              based on allergies and health conditions.
            </p>
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25 thq-body-small">
                      Easily upload photos of nutrition labels from food
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28 thq-body-small">
                      ...
                      health ratings and impact information.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26 thq-body-small">
                      Provide information about allergies and health conditions
                      to receive personalized substitution suggestions.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31 thq-body-small">
                      Read testimonials from satisfied users who have benefited
                      from NutriCheck&apos;s ingredient health impact analysis
